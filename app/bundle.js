	...
	var OverviewSlides = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				null,
				React.createElement(OverviewTitleSlide, null),
				React.createElement(OverviewContentSlide, null),
				React.createElement(OverviewImageSlide, null)
			);
		}
	});

	ReactDOM.render(React.createElement(OverviewSlides, null), document.getElementById('overview-slides'));
