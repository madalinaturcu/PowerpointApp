...
/***/ function(module, exports, __webpack_require__) {
	...
	var TitleSlide = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'type-title', onClick: this.props.addSlide },
				React.createElement(
					'p',
					null,
					' Title '
	...
	var ContentSlide = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'type-content', onClick: this.props.addSlide },
				React.createElement(
					'p',
					null,
					' Title '
	...
	var ImageSlide = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'type-img', onClick: this.props.addSlide },
				React.createElement(
					'p',
					null,
					' Title '
	...
	var Slides = React.createClass({
		...
		addNewTitleSlide: function addNewTitleSlide() {
			var titleSlide = {
				id: Math.random(),
				type: 'Title',
		...
		addNewContentSlide: function addNewContentSlide() {
			var contentSlide = {
				id: Math.random(),
				type: 'Content',
				title: 'Enter title here',
		...
		addNewImageSlide: function addNewImageSlide() {
			var imageSlide = {
				id: Math.random(),
				type: 'Image',
				title: 'Enter title here',
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(TitleSlide, { addSlide: this.addNewTitleSlide }),
						React.createElement(ContentSlide, { addSlide: this.addNewContentSlide }),
						React.createElement(ImageSlide, { addSlide: this.addNewImageSlide })
					)
				),
				React.createElement(
					'div',
	...
	var OverviewTitleSlide = React.createClass({
		...
		selectTitleSlideOverview: function selectTitleSlideOverview() {
			this.props.select(this.props.id);
		},
		deleteSelectedSlide: function deleteSelectedSlide() {
			this.props.deleteS(this.props.id);
		},
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'overview-slide-title', onClick: this.selectTitleSlideOverview },
				React.createElement(
					'button',
					{ onClick: this.deleteSelectedSlide },
					' x '
				),
				React.createElement(
					'p',
	...
	var OverviewContentSlide = React.createClass({
		...
		selectContentSlideOverview: function selectContentSlideOverview() {
			this.props.select(this.props.id);
		},
		deleteSelectedSlide: function deleteSelectedSlide() {
			this.props.deleteS(this.props.id);
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'overview-slide-content', onClick: this.selectContentSlideOverview },
				React.createElement(
					'button',
					{ onClick: this.deleteSelectedSlide },
					' x '
	...
	var OverviewImageSlide = React.createClass({
		...
		selectImageSlideOverview: function selectImageSlideOverview() {
			this.props.select(this.props.id);
		},
		deleteSelectedSlide: function deleteSelectedSlide() {
			this.props.deleteS(this.props.id);
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'overview-slide-image', onClick: this.selectImageSlideOverview },
				React.createElement(
					'button',
					{ onClick: this.deleteSelectedSlide },
					' x '
	...
	var OverviewSlides = React.createClass({
		...
		render: function render() {
			...
			var allOverviewSlides = this.props.data.map(function (slide) {
				if (slide.type === 'Title') {
					return React.createElement(OverviewTitleSlide, { key: slide.id, id: slide.id, title: slide.title, select: that.props.selectSlide, deleteS: that.props.deleteSlide });
				} else if (slide.type === 'Content') {
					return React.createElement(OverviewContentSlide, { key: slide.id, id: slide.id, title: slide.title, content: slide.content, select: that.props.selectSlide, deleteS: that.props.deleteSlide });
				} else {
					return React.createElement(OverviewImageSlide, { key: slide.id, id: slide.id, title: slide.title, image: slide.image, select: that.props.selectSlide, deleteS: that.props.deleteSlide });
				}
			});
	...
	var DetailsTitleSlide = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement('input', { placeholder: 'Enter title', value: this.state.title, onChange: this.handleTitleChange })
			);
		}
	});
	...
	var DetailsContentSlide = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'detail-content-slide' },
				React.createElement('input', { placeholder: 'Enter title', value: this.state.title, onChange: this.handleTitleChange }),
				React.createElement('textarea', { placeholder: 'Enter content', value: this.state.content, onChange: this.handleContentChange })
			);
		}
	});
	...
	var DetailsImageSlide = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'detail-content-slide' },
				React.createElement('input', { placeholder: 'Enter title here', value: this.state.title, onChange: this.handleTitleChange }),
				React.createElement('input', { placeholder: 'Enter image link here', value: this.state.image, onChange: this.handleImageChange }),
	...
	var DetailsSlides = React.createClass({
		...
		render: function render() {
			...
			if (this.props.selectedSlide.type === 'Title') {
				detailsSlideType = React.createElement(DetailsTitleSlide, { slide: this.props.selectedSlide, editSlide: this.props.editSlide });
			}
			if (this.props.selectedSlide.type === 'Content') {
				detailsSlideType = React.createElement(DetailsContentSlide, { slide: this.props.selectedSlide, editSlide: this.props.editSlide });
			}
			if (this.props.selectedSlide.type === 'Image') {
				detailsSlideType = React.createElement(DetailsImageSlide, { slide: this.props.selectedSlide, editSlide: this.props.editSlide });
			}
	...
	var App = React.createClass({
		...
		selectSlide: function selectSlide(slideId) {
		...
		editSlide: function editSlide(editedSlide) {
			var positionInArray;
			for (var i = 0; i < this.state.data.length; i++) {
		...
		render: function render() {
			return React.createElement(
				'div',
				null,
				React.createElement(Slides, { onAddNewSlide: this.addNewSlide }),
				React.createElement(
					'div',
					{ className: 'content' },
					React.createElement(OverviewSlides, { data: this.state.data, selectSlide: this.selectSlide, deleteSlide: this.deleteSlide }),
					React.createElement(DetailsSlides, { selectedSlide: this.state.selectedSlide, editSlide: this.editSlide })
				)
			);
		}
	});
